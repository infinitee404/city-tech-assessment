...
// 							Complete any combination of tasks below to reach 100 points. You don't need to complete all tasks.
// 						</p>
// 					</div>
// 				</div>
...
// 							<ul>
// 								<li>
// 									<code>GET /api/v1/merchants</code> - List all merchants (with pagination)
// 								</li>
// 								<li>
// 									<code>GET /api/v1/merchants/{'{id}'}</code> - Get merchant details
// 								</li>
// 								<li>
// 									<code>POST /api/v1/merchants</code> - Create new merchant
// 								</li>
// 								<li>
// 									<code>PUT /api/v1/merchants/{'{id}'}</code> - Update merchant
// 								</li>
// 								<li>
// 									<code>DELETE /api/v1/merchants/{'{id}'}</code> - Deactivate merchant
// 								</li>
// 							</ul>
// 						</div>
...
// 							<ul>
// 								<li>
// 									<code>MerchantList.tsx</code> - Table/list view of merchants
// 								</li>
// 								<li>
// 									<code>MerchantCard.tsx</code> - Individual merchant card component
// 								</li>
// 								<li>
// 									<code>MerchantForm.tsx</code> - Form for add/edit merchant
// 								</li>
// 								<li>
// 									<code>MerchantDetails.tsx</code> - Detailed merchant view
// 								</li>
// 								<li>
// 									<code>MerchantFilters.tsx</code> - Search and filter controls
// 								</li>
// 							</ul>
// 						</div>
...
// 							<ul>
// 								<li>
// 									Create custom hook: <code>useMerchants()</code>
// 								</li>
...
// 					<ol>
// 						<li>
// 							Create the merchant type definitions in <code>src/types/merchant.ts</code>
// 						</li>
// 						<li>
// 							Implement the merchant API service in <code>src/services/merchantService.ts</code>
// 						</li>
// 						<li>
// 							Create the custom hook <code>src/hooks/useMerchants.ts</code>
// 						</li>
// 						<li>
// 							Build the UI components in <code>src/components/merchants/</code>
// 						</li>
...
export const Merchants = () => {
	async function getMerchantsData() {
		const url = 'https://my-json-server.typicode.com/infinitee404/city-tech-assessment'
		try {
	...
	return (
		<main className='container'>
			<Button onClick={getMerchantsData}>Fetch Merchants Data</Button>
		</main>
	)
}
